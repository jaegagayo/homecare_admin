...
export const WORK_TYPE_COLORS: Record<WorkType, string> = {
  ...
  [WORK_TYPES.SHORT_TERM_CARE]: 'green',
...
export const WORK_TYPE_DESCRIPTIONS: Record<WorkType, string> = {
  ...
  [WORK_TYPES.SHORT_TERM_CARE]: '부득이한 사유로 가족의 보호를 받을 수 없어 일시적으로 보호가 필요한 심신이 허약한 노인과 장애노인을 시설에 단기간 입소시켜 보호',
