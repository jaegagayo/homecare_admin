import { Card, Heading, Text, Badge, Table, ScrollArea } from '@radix-ui/themes';
...
export default function CompletedSchedules({ schedules }: CompletedSchedulesProps) {
  ...
  return (
    <Card style={{ flex: 1 }}>
      <Heading size="4" mb="4">완료된 스케줄</Heading>
